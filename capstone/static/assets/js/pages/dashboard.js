...
$(function() {    
    ...
    trafficSources('#traffic-sources', 450); // initialize chart
    ...
    appSalesLines('#app_sales', 335); // initialize chart
    ...
    sparkline("#server-load", "area", 30, 100, "basis", 750, 2000, "rgba(255,255,255,0.5)");
    ...
    dailyRevenue('#today-revenue', 100); // initialize chart
    ...
    generateBarChart("#members-online", 24, 100, true, "elastic", 1200, 50, "rgba(255,255,255,0.5)", "members");
